...
async function loadDashboard() {
    try {
        ...
        errorDiv.style.cssText = 'position: fixed; top: 20px; left: 20px; background: #ef4444; color: white; padding: 20px; border-radius: 8px; z-index: 1000; max-width: 400px;';
        errorDiv.innerHTML = `<strong>Error loading dashboard:</strong><br>${error.message}`;
...
function renderTrendChart() {
    ...
    if (!ctx) {
        console.warn('Could not get context for trendChart');
        return;
    }
